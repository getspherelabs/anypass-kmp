...
public val AnyPassIcons.Messenger: ImageVector
    get() {
        ...
        _messenger = Builder(name = "Messenger", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = radialGradient(0.0f to Color(0xFF0099FF), 0.6f to Color(0xFFA033FF), 0.9f to
                    Color(0xFFFF5280), 1.0f to Color(0xFFFF7061), center = Offset(4.02f,23.9993f),
                    radius = 26.4f), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
