...
include(":features:passphrase:keypassword-api")
include(":features:passphrase:passphrase-impl")
include(":features:passphrase:passphrase-navigation")
include(":features:passphrase:keypassword-di")
