  ...
  override fun reduce(
    ...
    return when (currentWish) {
      ...
      is MasterPasswordWish.OnConfirmPasswordChanged -> {
        ...
        expect {
          currentState.copy(password = currentState.password, confirmPassword = newPassword)
        }
      }
      ...
      MasterPasswordWish.ClearPassword -> {
        expect {
          currentState.copy(password = "", confirmPassword = null, isInitialPasswordExisted = false)
        }
      }
