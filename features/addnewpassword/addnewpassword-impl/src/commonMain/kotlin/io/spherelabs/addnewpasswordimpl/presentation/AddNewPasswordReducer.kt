    ...
    private fun handleChanges(
        ...
        return when (currentWish) {
            ...
            is AddNewPasswordWish.OnPasswordChanged -> {
                expect {
                    currentState.copy(
                        password = currentWish.password?.trim() ?: String.Empty,
            ...
            is AddNewPasswordWish.OnTitleChanged -> {
                expect {
                    currentState.copy(
                        title = currentWish.title ?: String.Empty,
                        isTitleFailed = false,
                    )
                }
            }
            ...
            is AddNewPasswordWish.OnWebsiteAddressChanged -> {
                expect {
                    currentState.copy(
                        websiteAddress = currentWish.websiteAddress?.trim() ?: String.Empty,
                        isWebsiteFailed = false,
                    )
                }
            }
            AddNewPasswordWish.ToggleVisibility -> {
