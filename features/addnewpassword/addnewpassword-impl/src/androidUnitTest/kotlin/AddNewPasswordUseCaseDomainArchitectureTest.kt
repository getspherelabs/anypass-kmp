...
class AddNewPasswordUseCaseDomainArchitectureTest {
  ...
  fun `check add  new password classes with 'UseCase' suffix in 'usecase' package`() {
    Konsist.scopeFromPackage("io.spherelabs.addnewpassworddomain.usecase").classes().run {
  ...
  fun `check the interfaces with 'UseCase' suffix in 'usecase' package`() {
    Konsist.scopeFromPackage("io.spherelabs.addnewpassworddomain.usecase").interfaces().run {
      assertTrue { it.hasNameEndingWith("UseCase") }
      assertTrue { it.resideInPackage("..usecase..") }
    }
  }
  ...
  fun `check interface with 'Repository' suffix in 'repository' package`() {
    Konsist.scopeFromPackage("io.spherelabs.addnewpassworddomain.repository")
        .interfaces()
  ...
  fun `check use case function name is execute`() {
    Konsist.scopeFromPackage("io.spherelabs.addnewpassworddomain.usecase")
        .classes()
