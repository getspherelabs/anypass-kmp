...
class ChangePasswordMiddleware(
    ...
    private suspend fun handleGetCurrentKeyPassword(
        ...
        runCatching {
            getCurrentKeyPasswordUseCase.execute()
    ...
    private suspend fun handleSetNewKeyPassword(
        ...
        runCatching {
            setCurrentKeyPasswordUseCase.execute(newKeyPassword)
        }.onSuccess {
            next.invoke(ChangePasswordWish.UpdatedSuccessfully("Updated successfully!"))
        }
    }
}
